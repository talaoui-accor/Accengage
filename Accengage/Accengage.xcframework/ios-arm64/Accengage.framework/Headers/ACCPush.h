...
- (void)handleActionWithIdentifier:(NSString *)identifier
             forRemoteNotification:(NSDictionary *)notification __attribute__((deprecated("This method is deprecated starting from version 7.0.0. Use [[Accengage push] didReceiveNotificationResponse:] instead")));
...
- (void)handleActionWithIdentifier:(nullable NSString *)identifier
             forRemoteNotification:(NSDictionary *)notification
                  withResponseInfo:(NSDictionary *)responseInfo __attribute__((deprecated("This method is deprecated starting from version 7.0.0. Use [[Accengage push] didReceiveNotificationResponse:] instead")));
...
- (void)didReceiveLocalNotification:(UILocalNotification *)notification __attribute__((deprecated("This method is deprecated starting from version 7.0.0. Use [[Accengage push] willPresentNotification:] instead")));
 ...
 */
- (void)handleActionWithIdentifier:(nullable NSString *)identifier
              forLocalNotification:(UILocalNotification *)notification __attribute__((deprecated("This method is deprecated starting from version 7.0.0. Use [[Accengage push] didReceiveNotificationResponse:] instead")));
