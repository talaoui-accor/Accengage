...
//---------------------------------------------------------------------------------------
// ACCDeepLinkDelegate Protocol
//---------------------------------------------------------------------------------------

/**
 * Protocol to be implemented by deep link handlers.
 */
@protocol ACCDeepLinkDelegate<NSObject>

@optional

/*!
 * @brief Called when a deep link has been triggered from Accengage. If implemented, the delegate is responsible for processing the provided url.
 * @since 7.1.0
 *
...
/**
 * @brief A user configurable deep link delegate.
 * @since 7.1.0
 */
@property (nonatomic, weak, nullable) id<ACCDeepLinkDelegate> deepLinkDelegate;
...
*/
+ (void)updateWithConfig:(ACCConfiguration *)config;
